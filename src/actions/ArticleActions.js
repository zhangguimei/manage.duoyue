...
export const fetchArticleData = (id) => {
  let data = require("../assets/MockData/sourcecenter/article/article_data.json");
...
export const fetchTagsArrData = () => {
  let data = require('../assets/MockData/sourcecenter/article/article_tags_data.json');
  return dispatch => {
...
export const fetchResourceData = (type) => {
  let data = require('../assets/MockData/sourcecenter/article/article_item_data.json');
  let json = data[type];
